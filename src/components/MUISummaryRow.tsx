...
import { SummaryRowCell } from "../types";
...
const MUISummaryRow = (props: WithStyles<typeof styles>) => {
    const { classes } = props;
...
export default withStyles(styles, { name: "MUITableSummaryRow" })(MUISummaryRow);
